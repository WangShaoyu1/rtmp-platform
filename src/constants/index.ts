...
export const MINMAX_SPEAKERS = [
  {
    key: 'male-qn-qingse',
    label: ('minmax.male-qn-qingse'),
    value: 'male-qn-qingse',
  },
  {
    key: 'male-qn-jingying',
    label: ('minmax.male-qn-jingying'),
    value: 'male-qn-jingying',
  },
  {
    key: 'male-qn-badao',
    label: ('minmax.male-qn-badao'),
    value: 'male-qn-badao',
  },
  {
    key: 'male-qn-daxuesheng',
    label: ('minmax.male-qn-daxuesheng'),
    value: 'male-qn-daxuesheng',
  },
  {
    key: 'female-shaonv',
    label: ('minmax.female-shaonv'),
    value: 'female-shaonv',
  },
  {
    key: 'female-yujie',
    label: ('minmax.female-yujie'),
    value: 'female-yujie',
  },
  {
    key: 'female-chengshu',
    label: ('minmax.female-chengshu'),
    value: 'female-chengshu',
  },
  {
    key: 'female-tianmei',
    label: ('minmax.female-tianmei'),
    value: 'female-tianmei',
  },
  {
    key: 'presenter_male',
    label: ('minmax.presenter_male'),
    value: 'presenter_male',
  },
  {
    key: 'presenter_female',
    label: ('minmax.presenter_female'),
    value: 'presenter_female',
  },
  {
    key: 'audiobook_male_1',
    label: ('minmax.audiobook_male_1'),
    value: 'audiobook_male_1',
  },
  {
    key: 'audiobook_male_2',
    label: ('minmax.audiobook_male_2'),
    value: 'audiobook_male_2',
  },
  {
    key: 'audiobook_female_1',
    label: ('minmax.audiobook_female_1'),
    value: 'audiobook_female_1',
  },
  {
    key: 'audiobook_female_2',
    label: ('minmax.audiobook_female_2'),
    value: 'audiobook_female_2',
  },
  {
    key: 'male-qn-qingse-jingpin',
    label: ('minmax.male-qn-qingse-jingpin'),
    value: 'male-qn-qingse-jingpin',
  },
  {
    key: 'male-qn-jingying-jingpin',
    label: ('minmax.male-qn-jingying-jingpin'),
    value: 'male-qn-jingying-jingpin',
  },
  {
    key: 'male-qn-badao-jingpin',
    label: ('minmax.male-qn-badao-jingpin'),
    value: 'male-qn-badao-jingpin',
  },
  {
    key: 'male-qn-daxuesheng-jingpin',
    label: ('minmax.male-qn-daxuesheng-jingpin'),
    value: 'male-qn-daxuesheng-jingpin',
  },
  {
    key: 'female-shaonv-jingpin',
    label: ('minmax.female-shaonv-jingpin'),
    value: 'female-shaonv-jingpin',
  },
  {
    key: 'female-yujie-jingpin',
    label: ('minmax.female-yujie-jingpin'),
    value: 'female-yujie-jingpin',
  },
  {
    key: 'female-chengshu-jingpin',
    label: ('minmax.female-chengshu-jingpin'),
    value: 'female-chengshu-jingpin',
  },
  {
    key: 'female-tianmei-jingpin',
    label: ('minmax.female-tianmei-jingpin'),
    value: 'female-tianmei-jingpin',
  },
  { key: 'clever_boy', label: ('minmax.clever_boy'), value: 'clever_boy' },
  { key: 'cute_boy', label: ('minmax.cute_boy'), value: 'cute_boy' },
  {
    key: 'lovely_girl',
    label: ('minmax.lovely_girl'),
    value: 'lovely_girl',
  },
  {
    key: 'cartoon_pig',
    label: ('minmax.cartoon_pig'),
    value: 'cartoon_pig',
  },
];

export const MOON_SPEAKERS = [
  {
